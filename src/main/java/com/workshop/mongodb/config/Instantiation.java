...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Going into a trip!", "I am heading to São Paulo today!", maria);
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Good morning", "Woke up happy today!", maria);
